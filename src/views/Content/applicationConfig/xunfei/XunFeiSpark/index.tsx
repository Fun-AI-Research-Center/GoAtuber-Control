...
import {Configs2} from "../../azure/azureOpenAIConfig/configs.ts";
                        ...
                        <Row style={{width:"100%"}}>
                            ...
                            <Col span={19} >
                                ...
                                <ConfigRadioGroup
                                    title="记忆清理方式"
                                    ConfigItem={{
                                        propName:["application","xunfei","xun_fei_spark","memory_and_clean"],
                                        labels:["clean_all","clean_one"],
                                        texts:["清除全部","清除队首"],
                                        updateUrl:baseUrl+"/xunfei",
                                        updatePropsName:["application","xunfei"]
                                    }}
                                    Icon={Icon(text2)}
                                ></ConfigRadioGroup>
                            </Col>
